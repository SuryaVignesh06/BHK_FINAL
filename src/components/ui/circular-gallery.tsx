...
class App {
    ...
    constructor(
        ...
        this.update();
        this.addEventListeners(enableWheel);
    ...
    onCheck() {
        ...
        if (width < 10) return; // Prevent division by zero/small numbers during expansion
    ...
    update() {
        // Auto-scroll logic
        if (!this.isDown && this.active && this.autoScroll) {
        ...
        this.onCheck(); // Check for infinite loop logic constantly
        this.raf = window.requestAnimationFrame(this.update.bind(this));
    }

    addEventListeners(enableWheel: boolean) {
